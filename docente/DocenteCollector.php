...
class DocenteCollector extends Collector
{
  ...
  function showDocente() {
    ...
    $arrayDocente= array();        
    foreach ($rows as $c){
      $aux = new Docente($c{'id_profesor'},$c{'nombre'},$c{'apellido'},$c{'edad'},$c{'cedula'},$c{'genero'},$c{'dirigencia'},$c{'cargo'},$c{'email'});
  ...
  function showDocenteId($id) {
    ...
    $Docente = new Docente($row{'id_profesor'},$row{'nombre'},$row{'apellido'},$row{'edad'},$row{'cedula'},$row{'genero'},$row{'dirigencia'},$row{'cargo'},$row{'email'});
    return $Docente;        
  }
