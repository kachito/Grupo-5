<?php
 ...
 $TelefonoCollectorObj->insertTelefono($codigo_pais, $codigo_ciudad, $numero_telefono, $tipo_telefono);
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <a href="Telefono_list.php" >   <button type="button" class="btn btn-sm btn-default" data-dismiss="modal">Retornar</button> </a>
                                            </div>
                                        </div>
                    </div>
                </div>
