...
<div class="table-responsive"> 
  ...
  <tr>
     ...
     <td><a href="form_Actividad.php">Nuevo</a></td>   
     <td><a href="Actividad_edit.php?id=<?php echo $c->getid_actividad() ?>">Editar</a></td>
     <td><a href="Actividad_delete.php?id=<?php echo $c->getid_actividad() ?>">Eliminar</a></td>
  </tr>
  </tbody> 
  <?php  
  }
