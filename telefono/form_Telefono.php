                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Diario Virtual <i class="fa fa-angle-down"></i></a>
                                 <ul class="dropdown-menu">
                                    <li><a href="Telefono_list.php">Diario</a></li>
                        ...
                        <li><a href="../costruccion.html" class="dropdown-toggle" data-toggle="dropdown">Planificaciones <i class="fa fa-angle-down"></i></a>
                             <ul class="dropdown-menu">
                               ...
                               <li><a href="form_Telefono.php">Actividades</a></li>
...
<section id="contact-page">
        <div class="container">
            ...
            <div class="row contact-wrap"> 
                ...
                <form action= "Telefono_insert.php" method="post" action="form-horizontal"> 
                    <div class="col-sm-5 col-sm-offset-1">
                        <div class="form-group">
                            <label>Cod. País *</label>
                            <input type="number" name="codigo_pais" class="form-control" required="required">
                        </div>
                        <div class="form-group">
                            <label>Cod. Ciudad *</label>
                            <input type="number" name="codigo_ciudad" class="form-control" required="required">
                        </div>
                    ...
                    <div class="col-sm-5">
                        <div class="form-group">
                            <label>Numero *</label>
                            <input type="number" name="numero_telefono" class="form-control" required="required">
                        </div>
                        
                        <div class="form-group">
                            <label >Tipo</label>
                            <select type="text" name="tipo_telefono">
                                <option value="Pendiente" required="required">Trabajo</option>
                                <option value="Activo" required="required">Domicilio</option>
                                <option value="Cancelado" required="required">Otros</option>
                            </select>
