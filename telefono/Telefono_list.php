...
<div class="table-responsive"> 
    <table class="table table-condensed table-bordered table-hover">
        <thead>
            <tr>
                  ...
                  <th bgcolor="#D8D8D8">COD. PAIS</th>
                  <th bgcolor="#D8D8D8">COD. CIUDAD</th>
                  <th bgcolor="#D8D8D8">NUMERO</th>
  ...
  <?php  
    ...
    foreach ($TelefonoCollectorObj->showTelefono() as $c){
  ?>
  <tbody>
  <tr>
     <td><?php echo $c->getid_telefono() ?></td>
     <td><?php echo $c->getcodigo_pais() ?></td>
     <td><?php echo $c->getcodigo_ciudad() ?></td>
     <td><?php echo $c->getnumero_telefono() ?></td>
     <td><?php echo $c->gettipo_telefono() ?></td>

      </td>
   
     <td><a href="form_Telefono.php">Nuevo</a></td>   
     <td><a href="Telefono_edit.php?id=<?php echo $c->getid_telefono() ?>">Editar</a></td>
     <td><a href="Telefono_delete.php?id=<?php echo $c->getid_telefono() ?>">Eliminar</a></td>
  </tr>
  </tbody> 
  <?php  
  }
