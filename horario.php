                    ...
                    <div class="col-md-12">
                        ...
                        <div class="modal-content">
                                                <div class="modal-header">
                                                    <a href="home.php" > <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button> </a>
                                                ...
                                                <div class="modal-footer">
                                                    <a href="home.php" >   <button type="button" class="btn btn-sm btn-default" data-dismiss="modal">Close</button> </a>
                                                </div>
                        </div>
