...
<section id="contact-page">
        <div class="container">
            ...
            <div class="row contact-wrap"> 
                ...
                <form action= "Notas_insert.php" method="post" action="form-horizontal"> 
                    <div class="col-sm-5 col-sm-offset-1">
                        <div class="form-group">
                            <label>Fecha *</label>
                            <input type="date" name="anio" class="form-control" required="required">
                        </div>
                        <div class="form-group">
                            <label>1er Parcial *</label>
                            <input type="number" name="nota1" class="form-control" required="required">
                        </div>
                        <div class="form-group" >
                            <label>2do Parcial *</label>
                            <input type="number" name="nota2" class="form-control" required="required">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        ...
                        <div class="form-group">
                            <label>Exámen *</label>
                            <input type="number" name="nota4" class="form-control" required="required">
                        </div>
                        <div class="form-group">
                            <label>Promedio *</label>
                            <input type="number" name="promedio" class="form-control" required="required">
                        </div>
                        <div class="form-group">
                            <label>Recuperación *</label>  
                            <input type="number" name="recuperacion" class="form-control" required="required">
