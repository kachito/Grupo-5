...
class NotasCollector extends Collector
{
  ...
  function updateDocente($id_nota,$anio,$nota1,$nota2,$nota3,$nota4,$promedio,$recuperacion) {
 ...
 $delete = self::$db->getRow("Delete from nota where id_profesor= '$id'");   
  ...
  function insertDocente($anio,$nota1,$nota2,$nota3,$nota4,$promedio,$recuperacion) {
