...
<div class="table-responsive"> 
  ...
  <tr>
     ...
     <td><a href="form_notas.php">Nuevo</a></td>   
     <td><a href="Notas_edit.php?id=<?php echo $c->getid_nota() ?>">Editar</a></td>
     <td><a href="Notas_delete.php?id=<?php echo $c->getid_nota() ?>">Eliminar</a></td>
  </tr>
  </tbody> 
  <?php  
  }
