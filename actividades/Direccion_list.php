    ...
    <table class="table table-condensed table-bordered table-hover">
        <thead>
            <tr>
                  ...
                  <th bgcolor="#D8D8D8">DIRECCIÓN PRINCIPAL</th>
                  <th bgcolor="#D8D8D8">DIRECCIÓN SECUNDARIA</th>
                  <th bgcolor="#D8D8D8">DIRECCIÓN TRANSVERSAL</th>
                  <th colspan = 3 bgcolor="#D8D8D8">ACCION</th>
           </tr>
        </thead>
  <?php  

    foreach ($DireccionCollectorObj->showDireccion() as $c){
  ?>
  <tbody>
  <tr>
     <td><?php echo $c->getid_direccion() ?></td>
     <td><?php echo $c->getdireccion_principal() ?></td>
     <td><?php echo $c->getdireccion_secundaria() ?></td>
     <td><?php echo $c->getdireccion_transversal() ?></td>

      </td>
   
     <td><a href="form_Direccion.php">Nuevo</a></td>   
     <td><a href="Direccion_edit.php?id=<?php echo $c->getid_direccion() ?>">Editar</a></td>
     <td><a href="Direccion_delete.php?id=<?php echo $c->getid_direccion() ?>">Eliminar</a></td>
  </tr>
  </tbody> 
  <?php  
  }
