...
<section id="contact-page">
        <div class="container">
            ...
            <div class="row contact-wrap"> 
                ...
                <form action= "Direccion_insert.php" method="post" action="form-horizontal"> 
                    <div class="col-sm-5 col-sm-offset-1">
                        <div class="form-group">
                            <label>Dirección Principal *</label>
                            <input type="text" name="direccion_principal" class="form-control" required="required">
                        </div>
                        <div class="form-group">
                            <label>Dirección Secundaria *</label>
                            <input type="text" name="direccion_secundaria" class="form-control" required="required">
                        </div>
                    ...
                    <div class="col-sm-5">
                        ...
                        <div class="form-group">
                            <label>Dirección Transversal *</label>
                            <input type="text" name="direccion_transversal" class="form-control" required="required">
                        </div>                       
